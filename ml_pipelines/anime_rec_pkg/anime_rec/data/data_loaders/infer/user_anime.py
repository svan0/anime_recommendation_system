...
def _load_user_anime_retrieval_to_pd(data_path, file_format='csv'):
    ...
    user_anime_retrieval = user_anime_retrieval[['user_id']]
...
def _load_user_anime_ranking_to_pd(data_path, file_format='csv'):
    ...
    user_anime_ranking = user_anime_ranking[['user_id', 'anime_id']]
...
def _load_user_anime_list_ranking_to_pd(data_path, file_format='csv'):
    ...
    user_anime_list_ranking['user_id'] = user_anime_list_ranking['user_id'].apply(lambda x : [str(x)])
    user_anime_list_ranking['anime_id'] = user_anime_list_ranking['anime_id'].apply(lambda x : [str(x)])
    user_anime_list_ranking = user_anime_list_ranking[['user_id', 'anime_id']]
