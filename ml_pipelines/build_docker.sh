...
cd $PROJECT_PATH/pipelines/components/anime_anime/train/retrieval
...
cd $PROJECT_PATH/pipelines/components/anime_anime/infer/retrieval
...
cd $PROJECT_PATH/pipelines/components/anime_anime/train/ranking
...
cd $PROJECT_PATH/pipelines/components/anime_anime/infer/ranking
...
cd $PROJECT_PATH/pipelines/components/user_anime/infer/ranking
