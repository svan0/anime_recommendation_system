...
def anime_anime_retrieval_steps(list_anime_data, current_time, project_id, dataset_id, data_format):
    """
        Data Load
    """
    ...
    infer_retrieval_to_bq = gcs_to_bq_table(
        ...
        project_id=project_id,
        destination_dataset_id=dataset_id,
        destination_table_id=f"anime_anime_retrieval_infer_{current_time}"
    )
    infer_retrieval_to_bq.set_display_name("INFER: anime anime retrieval to BQ")
    
    return infer_retrieval_model

def anime_anime_ranking_steps(list_anime_data, anime_anime_to_rank, current_time, project_id, dataset_id, data_format):
    """
        Data Loading
    """
    ...
    infer_ranking_to_bq = gcs_to_bq_table(
        ...
        project_id=project_id,
        destination_dataset_id=dataset_id,
        destination_table_id=f"anime_anime_ranking_infer_{current_time}"
    )
